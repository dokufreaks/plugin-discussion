...
$lang['excluded_ns']           = 'Liste von Namensräumen in denen keine Diskussionen angezeigt werden sollen (wenn <code>automatic = true</code>, regulärer Ausdruck, z.B.: <code>/(playground|wiki)/</code>)';
